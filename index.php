...
<head>
    ...
    <!--====== Slick CSS ======-->
    <link rel="stylesheet" href="assetslp/css/slick.css">
        
    <!--====== Font Awesome CSS ======-->
    <link rel="stylesheet" href="assetslp/css/font-awesome.min.css">
        
    <!--====== Line Icons CSS ======-->
    <link rel="stylesheet" href="assetslp/css/LineIcons.css">
        
    <!--====== Animate CSS ======-->
    <link rel="stylesheet" href="assetslp/css/animate.css">
        
    <!--====== Magnific Popup CSS ======-->
    <link rel="stylesheet" href="assetslp/css/magnific-popup.css">
        
    <!--====== Bootstrap CSS ======-->
    <link rel="stylesheet" href="assetslp/css/bootstrap.min.css">
    
    <!--====== Default CSS ======-->
    <link rel="stylesheet" href="assetslp/css/default.css">
    
    <!--====== Style CSS ======-->
    <link rel="stylesheet" href="assetslp/css/style.css">
...
<body>
  ...
  <![endif]-->
    ...
    <header class="header-area">
        ...
        <div id="home" class="header-hero bg_cover d-lg-flex align-items-center" style="background-image: url(assetslp/images/header-hero.jpg)">
            <div class="container">
                <div class="row">
                    <div class="col-lg-7">
            ...
            <div class="header-hero-image d-flex align-items-center wow fadeInRightBig" data-wow-duration="1s" data-wow-delay="1.1s">
                <div class="image">
                    <img src="assetslp/images/hero-image.png" alt="Hero Image">
                </div>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="about-image mt-60 wow fadeIn" data-wow-duration="1s" data-wow-delay="0.5s">
                        <img src="assetslp/images/about.png" alt="about">
                    </div> <!-- about image -->
                </div>
            </div> <!-- row -->
            <div class="row justify-content-center">
                            ...
                            <div class="row">
                                <div class="col-sm-4">
                                    <div class="single-counter counter-color-1 mt-30 d-flex wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.3s">
                                        ...
                                        <div class="counter-content media-body">
                                            <span class="counter-count"><span class="counter">15</span></span>
                                ...
                                <div class="col-sm-4">
                                    <div class="single-counter counter-color-3 mt-30 d-flex wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.9s">
                                        ...
                                        <div class="counter-content media-body">
                                            <span class="counter-count"><span class="counter">40</span></span>
            ...
            <div class="service-wrapper mt-60 wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.6s">
                <div class="row no-gutters justify-content-center">
                    <div class="col-lg-4 col-md-7">
                        <div class="single-service d-flex">
                            <div class="service-icon">
                                <img src="assetslp/images/service-1.png" alt="Icon">
                            </div>
                            ...
                            <div class="shape shape-2">
                                <img src="assetslp/images/shape/shape-2.svg" alt="shape">
                            </div>
                        </div> <!-- single service -->
                    </div>
                    <div class="col-lg-4 col-md-7">
                        <div class="single-service service-border d-flex">
                            <div class="service-icon">
                                <img src="assetslp/images/service-2.png" alt="Icon">
                            </div>
                            <div class="service-content media-body">
                    ...
                    <div class="col-lg-4 col-md-7">
                        <div class="single-service d-flex">
                            <div class="service-icon">
                                <img src="assetslp/images/service-3.png" alt="Icon">
                            </div>
                            <div class="service-content media-body">
                            ...
                            <div class="shape shape-5">
                                <img src="assetslp/images/shape/shape-5.svg" alt="shape">
                            </div>
                        </div> <!-- single service -->
                    </div>
                </div> <!-- row -->
        ...
        <div class="container">
            ...
            <div class="row grid">
                <div class="col-lg-4 col-sm-6 grid-item apps creative laptop">
                    <div class="single-gallery gallery-masonry mt-30">
                        <div class="gallery-image">
                            <img src="assetslp/images/protfolio-1.jpg" alt="protfolio">
                        </div>
                        <div class="gallery-icon">
                            <a class="image-popup" href="assetslp/images/protfolio-1.jpg">
                                <span></span>
                            </a>
                        </div>
                    </div> <!-- single gallery -->
                ...
                <div class="col-lg-4 col-sm-6 grid-item branding creative">
                    <div class="single-gallery gallery-masonry mt-30">
                        <div class="gallery-image">
                            <img src="assetslp/images/protfolio-2.jpg" alt="protfolio">
                        </div>
                        <div class="gallery-icon">
                            <a class="image-popup" href="assetslp/images/protfolio-2.jpg">
                                <span></span>
                            </a>
                        </div>
                    </div> <!-- single gallery -->
                ...
                <div class="col-lg-4 col-sm-6 grid-item apps branding product">
                    <div class="single-gallery gallery-masonry mt-30">
                        <div class="gallery-image">
                            <img src="assetslp/images/protfolio-3.jpg" alt="protfolio">
                        </div>
                        <div class="gallery-icon">
                            <a class="image-popup" href="assetslp/images/protfolio-3.jpg">
                                <span></span>
                            </a>
                        </div>
                    </div> <!-- single gallery -->
                ...
                <div class="col-lg-4 col-sm-6 grid-item laptop product">
                    <div class="single-gallery gallery-masonry mt-30">
                        <div class="gallery-image">
                            <img src="assetslp/images/protfolio-5.jpg" alt="protfolio">
                        </div>
                        <div class="gallery-icon">
                            <a class="image-popup" href="assetslp/images/protfolio-5.jpg">
                                <span></span>
                            </a>
                        </div>
                    </div> <!-- single gallery -->
                ...
                <div class="col-lg-4 col-sm-6 grid-item branding creative">
                    <div class="single-gallery gallery-masonry mt-30">
                        <div class="gallery-image">
                            <img src="assetslp/images/protfolio-4.jpg" alt="protfolio">
                        </div>
                        <div class="gallery-icon">
                            <a class="image-popup" href="assetslp/images/protfolio-4.jpg">
                                <span></span>
                            </a>
                        </div>
                    </div> <!-- single gallery -->
                ...
                <div class="col-lg-4 col-sm-6 grid-item apps laptop product">
                    <div class="single-gallery gallery-masonry mt-30">
                        <div class="gallery-image">
                            <img src="assetslp/images/protfolio-6.jpg" alt="protfolio">
                        </div>
                        <div class="gallery-icon">
                            <a class="image-popup" href="assetslp/images/protfolio-6.jpg">
                                <span></span>
                            </a>
                        </div>
                    </div> <!-- single gallery -->
                ...
                <div class="row">
                    <div class="col-lg-4 col-md-6">
                        <div class="single-contact-info contact-color-1 mt-30 d-flex  wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.3s">
                            ...
                            <div class="contact-info-content media-body">
                                <p class="text">Bengaluru <br> India.</p>
                            </div>
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="single-contact-info contact-color-2 mt-30 d-flex  wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.6s">
                            ...
                            <div class="contact-info-content media-body">
                                <p class="text">statsproof@gmail.com</p>
    ...
    <footer id="footer" class="footer-area bg_cover" style="background-image: url(assetslp/images/footer-bg.jpg)">
        <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-3 col-sm-6 order-sm-3 order-lg-2">
                        <div class="footer-link pt-40">
                            ...
                            <ul>
                                <li><a href="#">Data Consultancy</a></li>
    ...
    <!--====== Jquery js ======-->
    <script src="assetslp/js/vendor/jquery-1.12.4.min.js"></script>
    <script src="assetslp/js/vendor/modernizr-3.7.1.min.js"></script>
    ...
    <!--====== Slick js ======-->
    <script src="assetslp/js/slick.min.js"></script>
    
    <!--====== Isotope js ======-->
    <script src="assetslp/js/imagesloaded.pkgd.min.js"></script>
    <script src="assetslp/js/isotope.pkgd.min.js"></script>
    
    <!--====== Counter Up js ======-->
    <script src="assetslp/js/waypoints.min.js"></script>
    <script src="assetslp/js/jquery.counterup.min.js"></script>
    
    <!--====== Circles js ======-->
    <script src="assetslp/js/circles.min.js"></script>
    
    <!--====== Appear js ======-->
    <script src="assetslp/js/jquery.appear.min.js"></script>
    
    <!--====== WOW js ======-->
    <script src="assetslp/js/wow.min.js"></script>
    
    <!--====== Headroom js ======-->
    <script src="assetslp/js/headroom.min.js"></script>
    
    <!--====== Jquery Nav js ======-->
    <script src="assetslp/js/jquery.nav.js"></script>
    
    <!--====== Scroll It js ======-->
    <script src="assetslp/js/scrollIt.min.js"></script>
    
    <!--====== Magnific Popup js ======-->
    <script src="assetslp/js/jquery.magnific-popup.min.js"></script>
