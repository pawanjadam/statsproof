...
mysqli_query($connect, "INSERT INTO statsproof.sitevisits(page, userip, visittime) VALUES(3, '$userip', '$date')");
?>
<!DOCTYPE html>
            ...
            <div class="card-body">
              ...
              <div class="mb-3">
                <!-- <?php echo $loginButton;?> -->
                  ...
                  <button style="background:#f14836; color: white;" class="btn d-grid w-100">Sign in with Google</button>
                  </a>
                </div>
