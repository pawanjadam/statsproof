    ...
    foreach($script as $data){
      	if(strpos($data->nodeValue, 'var ytInitialData =')!==false){
            ...
            $data = 8;
      		...
      		$primary = $required['contents']['twoColumnBrowseResultsRenderer']['tabs'][$data]['tabRenderer']['content']['sectionListRenderer']['contents'][0]['itemSectionRenderer']['contents'][0]['channelAboutFullMetadataRenderer']['links'];
          $count = 0;
